    ...
    <div className="detailContainer">
      ...
      <div className="container2">
        ...
        <div className="petDescription">
          <div className="petDescription2">
            <p>Size: {Det.size}</p>
            <p>Sex: {Det.sex}</p>
            <p>Detail: {Det.detail}</p>
            <p>Age: {Det.age}</p>
            <p>Area: {Det.area}</p>
            <p>Specie: {Det.species}</p>
          </div>
        </div>
      </div>
      <section className="banner container2">
        ...
        <div className="bannerImg">
          <img
            src="https://img.freepik.com/vector-premium/huella-ilustracion-3d-o-pata-perro-o-lobo-tono-blanco_391563-757.jpg?w=2000"
            alt=""
          />
          <h2>Adopt me!</h2>
        </div>
