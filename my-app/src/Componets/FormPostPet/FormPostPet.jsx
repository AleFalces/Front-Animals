      ...
      <form onSubmit={handlerSubmit}>
        ...
        >
          ...
          <Stack spacing={8} mx={'auto'} maxW={'lg'} py={12} px={6}>
                ...
                <HStack>
                  <Box>
                    <FormControl id="species" isRequired>
                      <Select focusBorderColor={'brand.green.300'} fontFamily={'body'} name="species" onChange={(e) => handlerChange(e)}>
                      ...
                      {inputError.species && <Text className="text_inputError">{inputError.species}</Text>}
                  ...
                  <Box >
                    <FormControl id="sex">
                      <Select focusBorderColor={'brand.green.300'} fontFamily={'body'} name="sex" key="sex" onChange={(e) => handlerChange(e)}>
                      ...
                      {inputError.sex && <Text className="text_inputError">{inputError.sex}</Text>}
                    </FormControl>
                  </Box>
                </HStack>

                <FormControl id="age" isRequired>
                  <Select focusBorderColor={'brand.green.300'} fontFamily={'body'} name="age" key="age" onChange={(e) => handlerChange(e)}>
                  ...
                  {inputError.age && <Text className="text_inputError">{inputError.age}</Text>}

                </FormControl>
                <FormControl id='size' isRequired>
                  <Select focusBorderColor={'brand.green.300'} fontFamily={'body'} name="size" key="size" onChange={(e) => handlerChange(e)}>
                  ...
                  {inputError.size && <Text className="text_inputError">{inputError.size}</Text>}

                </FormControl>
                <FormControl id='status' isRequired>
                  <Select focusBorderColor={'brand.green.300'} fontFamily={'body'} name="status" key="status" onChange={(e) => handlerChange(e)}>
                  ...
                  {inputError.status && <Text className="text_inputError">{inputError.status}</Text>}
                </FormControl>

                <FormControl>
                  <Text fontFamily={'body'} fontSize="14px">Área:</Text>
                  <Input
                    type="text"
                    fontFamily={'body'}
                    name="area"
                  ...
                  />
                  {inputError.area && <Text className="text_inputError">{inputError.area}</Text>}
                </FormControl>


                <FormControl>
                  <Text fontFamily={'body'} fontSize="14px" >Detalles:</Text>
                  <Input fontFamily={'body'} variant='flushed' focusBorderColor={'brand.green.300'} placeholder="Descripción de la mascota.." size='md' name="detail" onChange={(e) => handlerChange(e)} />
                  {inputError.detail && <Text className="text_inputError">{inputError.detail}</Text>}
                </FormControl>

                <FormControl>
                  <Text fontFamily={'body'} fontSize="14px" >ID de Usuario:</Text>
            ...
            <Link to={"/home"}>
              <Icon as={MdArrowBackIosNew} color='orange.400' boxSize={5} _hover={{
                color: 'grey',
                boxSize: '7'
              }} />
              <Icon as={MdArrowBackIosNew} color='orange.400' boxSize={5} _hover={{
